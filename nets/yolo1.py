...
from nets.CSPdarknet1 import C3, Conv, CSPDarknet
...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, phi, pad=0, backbone='cspdarknet', pretrained=False,
                 input_shape=[640, 640]):
...
# # 实例化CSP网络，查看变量参数
    # def __init__(self, anchors_mask, num_classes=20, phi='s', pad=0, backbone='cspdarknet', pretrained=False,
    #              input_shape=[640, 640]):

# device = torch.device("cuda")
# model = YoloBody(anchors_mask=[[6, 7, 8], [3, 4, 5], [0, 1, 2]], phi='s', pad=0, backbone='cspdarknet').to(device)
# print(model)
# summary(model, (3, 640, 640))
# a = torch.randn(1, 3, 640, 640).to(device)
#
# if __name__=="__main__":
#     b1, b2, b3 = model.forward(a)
#     print(b1.shape)
#     print(b2.shape)
#     print(b3.shape)
