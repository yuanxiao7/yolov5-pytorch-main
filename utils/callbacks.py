...
class LossHistory():
    def __init__(self, log_dir, model, input_shape):   # 传入的是想要存loss等指标的文件路径、yolo模型init、模型图片shape
    ...
    def append_loss(self, epoch, loss, val_loss):
        ...
        self.writer.add_scalar('loss', loss, epoch)  # 绘制对象、值域、定义域
